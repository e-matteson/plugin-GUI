...
#ifndef TESTSINKEDITOR_H_INCLUDED
#define TESTSINKEDITOR_H_INCLUDED
...
class TestSinkEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders.
...
public:
	...
	TestSinkEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);
...
private:
	...
	*/
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TestSinkEditor);
};
