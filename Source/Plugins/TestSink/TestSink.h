...
#ifndef TESTSINK_H_INCLUDED
#define TESTSINK_H_INCLUDED
...
class TestSink : public GenericProcessor
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TestSink);

};

#endif  // TESTSINK_H_INCLUDED
