...
*/
/*
AudioProcessorEditor* TestSink::createEditor()
{
	editor = new TestSinkEditor(this, true);
...
void TestSink::setParameter(int parameterIndex, float newValue)
{
...
void TestSink::process(AudioSampleBuffer& buffer,
                               MidiBuffer& events)
{
	/**
