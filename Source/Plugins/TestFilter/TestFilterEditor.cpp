...
TestFilterEditor::TestFilterEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
TestFilterEditor::~TestFilterEditor()
{
}
...
*/
void TestFilterEditor::buttonEvent(Button* button)
{
