...
#ifndef TESTFILTER_H_INCLUDED
#define TESTFILTER_H_INCLUDED
...
class TestFilter : public GenericProcessor
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TestFilter);

};

#endif  // TESTFILTER_H_INCLUDED
