...
#ifndef TESTSOURCEEDITOR_H_INCLUDED
#define TESTSOURCEEDITOR_H_INCLUDED
...
class TestSourceEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders.
...
public:
	...
	TestSourceEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);
...
private:
	...
	*/
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TestSourceEditor);
};
