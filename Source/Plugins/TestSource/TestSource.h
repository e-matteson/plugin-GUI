...
#ifndef TESTSOURCE_H_INCLUDED
#define TESTSOURCE_H_INCLUDED
...
class TestSource : public GenericProcessor
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(TestSource);

};

#endif  // TESTSOURCE_H_INCLUDED
