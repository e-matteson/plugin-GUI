...
#ifndef MOTORVELOCITYDECODER_H_INCLUDED
#define MOTORVELOCITYDECODER_H_INCLUDED
...
class MotorVelocityDecoder : public GenericProcessor

{
public:

    /** The class constructor, used to initialize any members. */
	MotorVelocityDecoder();
...
private:
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MotorVelocityDecoder);
...
#endif  // MOTORVELOCITYDECODER_H_INCLUDED
