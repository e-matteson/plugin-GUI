...
MotorVelocityDecoderEditor::MotorVelocityDecoderEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
MotorVelocityDecoderEditor::~MotorVelocityDecoderEditor()
{
}
...
*/
void MotorVelocityDecoderEditor::buttonEvent(Button* button)
{
