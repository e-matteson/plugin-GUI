...
#ifndef MOTORVELOCITYDECODEREDITOR_H_INCLUDED
#define MOTORVELOCITYDECODEREDITOR_H_INCLUDED
...
class MotorVelocityDecoderEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders.
...
public:
	...
	MotorVelocityDecoderEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);

	/** The class destructor, used to deallocate memory */
	~MotorVelocityDecoderEditor();
...
private:
	...
	*/
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MotorVelocityDecoderEditor);
};
