...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "Motor velocity decoder library"; //Name of the Library, used only for information
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//For processor
		info->processor.name = "Motor Velocity Decoder"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<MotorVelocityDecoder>); //Class factory pointer. Replace "ExampleProcessor" with the name of your class.
		break;
/**
