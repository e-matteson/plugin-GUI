...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "Applied Motion Motor library"; //Name of the Library, used only for information
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//For processor
		info->processor.name = "Applied Motion Motor Output"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<MotorOutput>); //Class factory pointer. Replace "ExampleProcessor" with the name of your class.
		break;
/**
