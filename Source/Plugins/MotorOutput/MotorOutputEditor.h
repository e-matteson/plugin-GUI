...
#ifndef MOTOROUTPUTEDITOR_H_INCLUDED
#define MOTOROUTPUTEDITOR_H_INCLUDED
...
class MotorOutputEditor : public GenericEditor	//Generic Editor adds listeners for buttons and sliders.
...
public:
	...
	MotorOutputEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors);
...
private:
	...
	*/
	...
	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MotorOutputEditor);
};
