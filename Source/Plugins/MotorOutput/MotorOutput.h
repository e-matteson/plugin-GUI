...
#ifndef MOTOROUTPUT_H_INCLUDED
#define MOTOROUTPUT_H_INCLUDED
...
class MotorOutput : public GenericProcessor
...
private:
	...
	std::string debugPath = "Motor_debug.txt";

	JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(MotorOutput);

};

#endif  // MOTOROUTPUT_H_INCLUDED
