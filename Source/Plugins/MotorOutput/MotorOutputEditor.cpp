...
#include "MotorOutputEditor.h"
#include "MotorOutput.h"

MotorOutputEditor::MotorOutputEditor(GenericProcessor* parentNode, bool useDefaultParameterEditors = true)
...
MotorOutputEditor::~MotorOutputEditor()
{
}
...
*/
void MotorOutputEditor::buttonEvent(Button* button)
{
