...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "Blackrock NSP Datathread library"; //Name of the Library, used only for information
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//For processor
		info->dataThread.name = "Blackrock NSP Source"; //Processor name shown in the GUI
		info->dataThread.creator = &createDataThread<NSPSource>; //Class factory pointer. Replace "ExampleProcessor" with the name of your class.
		break;
